...
console.log("XOFE: Background script loaded - Clean Tooltip v3.0.0");

// Note: Using embedded wallet with WebAuthn passkeys directly in content script
// No need to load complex SDK in background script
